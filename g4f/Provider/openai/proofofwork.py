...
def generate_proof_token(required: bool, seed: str = "", difficulty: str = "", user_agent: str = None, proof_token: str = None):
    ...
    if proof_token is None:
        screen = secrets.choice([3008, 4010, 6000]) * secrets.choice([1, 2, 4])
        ...
        proof_token = [
            ...
            secrets.choice(["_reactListeningcfilawjnerp", "_reactListening9ne2dfo1i47", "_reactListening410nzwhan2a"]),
            secrets.choice(["alert", "ontransitionend", "onprogress"])
        ]
